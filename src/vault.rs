...
pub mod vault {
    const _: () = {
        ::core::include_bytes!(
            "/Users/cyan/Work/EthereumWorkSpace/hdeposit/abi/Vault.abi",
        );
    };
    #[allow(deprecated)]
    ...
    impl<M: ::ethers::providers::Middleware> Vault<M> {
        ...
        pub fn deposit(
            ...
            self.0
                .method_hash(
                    [67, 25, 119, 207],
                    (pubkeys, signatures, deposit_data_roots, withdrawal_credentials, ns),
                )
                .expect("method not found (this should never happen)")
        }
    ...
    #[ethevent(name = "SetWithdrawalELFee", abi = "SetWithdrawalELFee(address,uint256)")]
    ...
    impl ::core::fmt::Display for VaultEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::SetDepositFeeFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::SetDepositorFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::SetELFeeFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::SetFeeCollectorFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::SetWithdrawalELFeeFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
    ...
    #[ethcall(name = "deposit", abi = "deposit(bytes,bytes,bytes32[],bytes,uint32[])")]
    ...
    #[ethcall(name = "setWithdrawalELFee", abi = "setWithdrawalELFee(address,uint256)")]
    ...
    impl ::ethers::core::abi::AbiDecode for VaultCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <CollectFeeCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::CollectFee(decoded));
            }
            if let Ok(decoded)
                = <CollectedDepositFeeCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <DepositFeeCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <EthDepositContractCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::EthDepositContract(decoded));
            }
            if let Ok(decoded)
                = <FeeCollectorCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::FeeCollector(decoded));
            }
            if let Ok(decoded)
                = <OnSplitFeeCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <PreDepositCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <SetDepositFeeCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <SetWithdrawalELFeeCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::SetWithdrawalELFee(decoded));
            }
            if let Ok(decoded)
                = <ToDepositCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <TotalSplitFeeCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <WithdrawalAddr2FeeContractCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for VaultCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::OnSplitFee(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::Owner(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::Paused(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::PreDeposit(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::RenounceOwnership(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::SetDepositFee(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                ...
                Self::ToDeposit(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::TotalDepositFee(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::TotalSplitFee(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
