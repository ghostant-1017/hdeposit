...
pub async fn get_balance(
    ...
    for validator in validators {
        ...
        pending_protocol_balance += (validator.balance as i64) - (validator.validator.effective_balance as i64);
    }  
    Ok(Json(Response { total_balance, effective_balance, pending_protocol_balance, annual_rewards_rate: 0.0 }))
}