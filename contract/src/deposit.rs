...
pub mod deposit_contract {
    const _: () = {
        ::core::include_bytes!("../abi/Deposit.abi",);
    };
    #[allow(deprecated)]
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        ...
                        inputs: ::std::vec![
                            ...
                            ::ethers::core::abi::ethabi::Param {
                                name: ::std::borrow::ToOwned::to_owned("withdrawal_credentials",),
                                kind: ::ethers::core::abi::ethabi::ParamType::Bytes,
                                internal_type: ::core::option::Option::Some(
                                    ::std::borrow::ToOwned::to_owned("bytes"),
                                ),
    ...
    impl<M: ::ethers::providers::Middleware> DepositContract<M> {
        ...
        pub fn deposit_event_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, DepositEventFilter>
        {
            self.0.event()
        }
    ...
    impl ::ethers::core::abi::AbiEncode for DepositContractCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::GetDepositCount(element) => ::ethers::core::abi::AbiEncode::encode(element),
